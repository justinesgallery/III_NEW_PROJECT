                    ...
                    <div class="dashboard">
                        <div class="options">
                            <div class="option-card">
                                ...
                                <p>Click here to apply for admission to our institution.</p>
                                <button class="option-button" onclick="location.href='pass_admission.php'">Apply Now</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="dashboard">
                        <div class="options">
                            <div class="option-card">
                                <h2>Check Admission</h2>
                                <p>Click here to check all the admissions.</p>
                                <button class="option-button" onclick="location.href='passed_admissions.php'">View Admissions</button>
                            </div>
                        </div>
                    </div>
                </div>
